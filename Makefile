...
$(SIM_BIN): simulator.cpp $(SIM_LIB)
	$(CXX) simulator.cpp $(VERILATOR_INCLUDE_DIR)/verilated_vcd_c.cpp  $(VERILATOR_INCLUDE_DIR)/verilated.cpp obj_dir/Vsimulator__ALL.a -o $(SIM_BIN) -Iobj_dir/ -I$(VERILATOR_INCLUDE_DIR)